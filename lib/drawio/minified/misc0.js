! function(a, b) {
  ...
  function c(a, b, c, d) {
    var e = [
      ...
      i = h && '-' + h + '-' || '';
    return l[e] || (m.insertRule('@' + i + 'keyframes ' + e + '{0%{opacity:' + g + '}' + f + '%{opacity:' + a + '}' + (f + 0.01) + '%{opacity:1}' + (f + b) % 100 + '%{opacity:' + a + '}100%{opacity:' + g + '}}', m.cssRules.length), l[e] = 1), e;
  }
...
! function(e, t) {
  ...
  var y, b = _(Array.prototype.forEach),
  ...
  return function t() {
    ...
    if (r.version = '2.3.6', r.removed = [], !n || !n.document || 9 !== n.document.nodeType)
    ...
    var de, he, ge = G,
      ...
      it = function(t) {
        rt && rt === t || (t && 'object' === e(t) || (t = {}), t = D(t), Ae = 'ALLOWED_TAGS' in t ? O({}, t.ALLOWED_TAGS) : we, xe = 'ALLOWED_ATTR' in t ? O({}, t.ALLOWED_ATTR) : Se, Ve = 'ADD_URI_SAFE_ATTR' in t ? O(D($e), t.ADD_URI_SAFE_ATTR) : $e, Ye = 'ADD_DATA_URI_TAGS' in t ? O(D(Ke), t.ADD_DATA_URI_TAGS) : Ke, We = 'FORBID_CONTENTS' in t ? O({}, t.FORBID_CONTENTS) : qe, _e = 'FORBID_TAGS' in t ? O({}, t.FORBID_TAGS) : {}, Oe = 'FORBID_ATTR' in t ? O({}, t.FORBID_ATTR) : {}, Ge = 'USE_PROFILES' in t && t.USE_PROFILES, De = !1 !== t.ALLOW_ARIA_ATTR, Ce = !1 !== t.ALLOW_DATA_ATTR, Me = t.ALLOW_UNKNOWN_PROTOCOLS || !1, Re = t.SAFE_FOR_TEMPLATES || !1, Le = t.WHOLE_DOCUMENT || !1, He = t.RETURN_DOM || !1, Ue = t.RETURN_DOM_FRAGMENT || !1, ze = t.RETURN_TRUSTED_TYPE || !1, Fe = t.FORCE_BODY || !1, Be = !1 !== t.SANITIZE_DOM, je = !1 !== t.KEEP_CONTENT, Pe = t.IN_PLACE || !1, Ee = t.ALLOWED_URI_REGEXP || Ee, Qe = t.NAMESPACE || Je, t.CUSTOM_ELEMENT_HANDLING && at(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (ke.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck), t.CUSTOM_ELEMENT_HANDLING && at(t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (ke.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), t.CUSTOM_ELEMENT_HANDLING && 'boolean' == typeof t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements && (ke.allowCustomizedBuiltInElements = t.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), de = de = -1 === tt.indexOf(t.PARSER_MEDIA_TYPE) ? nt : t.PARSER_MEDIA_TYPE, he = 'application/xhtml+xml' === de ? function(e) {
          return e;
        } : N, Re && (Ce = !1), Ue && (He = !0), Ge && (Ae = O({}, o(U)), xe = [], !0 === Ge.html && (O(Ae, M), O(xe, z)), !0 === Ge.svg && (O(Ae, R), O(xe, B), O(xe, P)), !0 === Ge.svgFilters && (O(Ae, L), O(xe, B), O(xe, P)), !0 === Ge.mathMl && (O(Ae, F), O(xe, j), O(xe, P))), t.ADD_TAGS && (Ae === we && (Ae = D(Ae)), O(Ae, t.ADD_TAGS)), t.ADD_ATTR && (xe === Se && (xe = D(xe)), O(xe, t.ADD_ATTR)), t.ADD_URI_SAFE_ATTR && O(Ve, t.ADD_URI_SAFE_ATTR), t.FORBID_CONTENTS && (We === qe && (We = D(We)), O(We, t.FORBID_CONTENTS)), je && (Ae['#text'] = !0), Le && O(Ae, [
          'html',
          'head',
          'body'
        ]), Ae.table && (O(Ae, ['tbody']), delete _e.tbody), m && m(t), rt = t);
      },
      lt = O({}, [
        'mi',
        'mo',
    ...
    var mt = function(e) {
        ...
        if (e.namespaceURI === Ze)
          return t.namespaceURI === Je ? 'svg' === n : t.namespaceURI === Xe ? 'svg' === n && ('annotation-xml' === r || lt[r]) : Boolean(ut[n]);
        if (e.namespaceURI === Xe)
          return t.namespaceURI === Je ? 'math' === n : t.namespaceURI === Ze ? 'math' === n && ct[r] : Boolean(st[n]);
        if (e.namespaceURI === Je) {
          if (t.namespaceURI === Ze && !ct[r])
            return !1;
          if (t.namespaceURI === Xe && !lt[r])
            return !1;
          var o = O({}, [
            'title',
            'style',
      ...
      vt = function(e) {
        ...
        if (bt('uponSanitizeElement', e, {
            tagName: n,
            allowedTags: Ae
          }), !yt(e.firstElementChild) && (!yt(e.content) || !yt(e.content.firstElementChild)) && S(/<[/\w]/g, e.innerHTML) && S(/<[/\w]/g, e.textContent))
          return ft(e), !0;
        if ('select' === n && S(/<template/i, e.innerHTML))
          return ft(e), !0;
        if (!Ae[n] || _e[n]) {
          if (!_e[n] && Nt(n)) {
        ...
        return e instanceof s && !mt(e) ? (ft(e), !0) : 'noscript' !== n && 'noembed' !== n || !S(/<\/no(script|embed)/i, e.innerHTML) ? (Re && 3 === e.nodeType && (t = e.textContent, t = A(t, ge, ' '), t = A(t, ye, ' '), e.textContent !== t && (T(r.removed, {
          element: e.cloneNode()
        }), e.textContent = t)), bt('afterSanitizeElements', e, null), !1) : (ft(e), !0);
      },
      Tt = function(e, t, n) {
        ...
        if (Ce && !Oe[t] && S(be, t));
          ...
          if (!(Nt(e) && (ke.tagNameCheck instanceof RegExp && S(ke.tagNameCheck, e) || ke.tagNameCheck instanceof Function && ke.tagNameCheck(e)) && (ke.attributeNameCheck instanceof RegExp && S(ke.attributeNameCheck, t) || ke.attributeNameCheck instanceof Function && ke.attributeNameCheck(t)) || 'is' === t && ke.allowCustomizedBuiltInElements && (ke.tagNameCheck instanceof RegExp && S(ke.tagNameCheck, n) || ke.tagNameCheck instanceof Function && ke.tagNameCheck(n))))
            return !1;
        } else if (Ve[t]);
        else if (S(Ee, A(n, Ne, '')));
        else if ('src' !== t && 'xlink:href' !== t && 'href' !== t || 'script' === e || 0 !== w(n, 'data:') || !Ye[e]) {
          if (Me && !S(Te, A(n, Ne, '')));
          else if (n)
            return !1;
        } else;
        ...
        if (i) {
          ...
          for (a = i.length; a--;) {
            var c = t = i[a],
              u = c.name,
              s = c.namespaceURI;
            if (n = 'value' === u ? t.value : x(t.value), o = he(u), l.attrName = o, l.attrValue = n, l.keepAttr = !0, l.forceKeepAttr = void 0, bt('uponSanitizeAttribute', e, l), n = l.attrValue, !l.forceKeepAttr && (pt(u, e), l.keepAttr))
              if (S(/\/>/i, n))
                pt(u, e);
              else {
      ...
      At = function e(t) {
        ...
        for (bt('beforeSanitizeShadowDOM', t, null); n = r.nextNode();)
          bt('uponSanitizeShadowNode', n, null), vt(n) || (n.content instanceof l && e(n.content), Et(n));
        bt('afterSanitizeShadowDOM', t, null);
      };
    return r.sanitize = function(t, o) {
      var i, c, s, m, f;
      if ((et = !t) && (t = '<!-->'), 'string' != typeof t && !yt(t)) {
      ...
      if (Ie || it(o), r.removed = [], 'string' == typeof t && (Pe = !1), Pe) {
        ...
        1 === (c = (i = dt('<!---->')).ownerDocument.importNode(t, !0)).nodeType && 'BODY' === c.nodeName || 'HTML' === c.nodeName ? i = c : i.appendChild(c);
      else {
        if (!He && !Re && !Le && -1 === t.indexOf('<'))
          return oe && ze ? oe.createHTML(t) : t;
        if (!(i = dt(t)))
          return He ? null : ze ? ae : '';
      }
      i && Fe && ft(i.firstChild);
      for (var d = ht(Pe ? t : i); s = d.nextNode();)
        3 === s.nodeType && s === m || vt(s) || (s.content instanceof l && At(s.content), Et(s), m = s);
      if (m = null, Pe)
        return t;
      if (He) {
        if (Ue)
